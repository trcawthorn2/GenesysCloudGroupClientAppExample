...
export default Component.extend({
    ...
    columnDefs: Ember.computed(function () {
        return [
            { key: 'name', header: 'Name', width: '40%', filter:{type:'search'} , component:'link-to-cell'},
            { key: 'id', header: 'Id', width: '40%', component:'link-to-cell' },
            { key: 'memberCount', header: 'Member Count', width: '5%' },
        ];
    })
});
